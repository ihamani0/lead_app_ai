...
export function ConnectingStatus({
    ...
    const cardStyles = cn(
        'relative animate-in overflow-hidden border-0 shadow-2xl duration-500 fade-in slide-in-from-bottom-4',
        isWaitingForQr
            ? 'bg-linear-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-900 dark:via-slate-900 dark:to-blue-950/20'
            : 'bg-linear-to-br from-amber-50 via-white to-orange-50 dark:from-slate-900 dark:via-slate-900 dark:to-amber-950/20',
    );
            ...
            <Card className={cardStyles}>
                ...
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -inset-full animate-[spin_6s_linear_infinite] opacity-20">
                        <div
                            className={`h-full w-full ${isWaitingForQr ? 'bg-[conic-gradient(from_0deg,transparent_0_340deg,blue-400_360deg)]' : 'bg-[conic-gradient(from_0deg,transparent_0_340deg,amber-400_360deg)]'}`}
                        />
                    </div>
                </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="relative mb-8">
                            <div className="absolute inset-0 animate-[spin_3s_linear_infinite]">
                                <div
                                    className={`h-32 w-32 rounded-full border-4 border-dashed ${isWaitingForQr ? 'border-blue-300/50 dark:border-blue-700/30' : 'border-amber-300/50 dark:border-amber-700/30'}`}
                                />
                            </div>

                            <div className="absolute inset-2 animate-pulse">
                                <div
                                    className={`h-28 w-28 rounded-full border-2 ${isWaitingForQr ? 'border-blue-400/30 dark:border-blue-600/20' : 'border-amber-400/30 dark:border-amber-600/20'}`}
                                />
                            </div>

                            <div className="flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-xl dark:bg-slate-800">
                                {isWaitingForQr ? (
                                    <QrCode className="h-12 w-12 animate-pulse text-blue-500" />
                                ) : (
                        ...
                        <p className="mb-6 max-w-md text-slate-600 dark:text-slate-400">
                            {isWaitingForQr ? (
                                ...
                                <>
                                    Connection lost or starting. We are
                                    automatically trying to connect{' '}
                        ...
                        {!isWaitingForQr && (
                            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                                <Button
                                    ...
                                    className="group relative overflow-hidden bg-linear-to-r from-amber-500 to-orange-500 px-8 py-6 text-base font-bold text-white shadow-lg transition-all hover:scale-105 active:scale-95 disabled:opacity-60"
                                >
