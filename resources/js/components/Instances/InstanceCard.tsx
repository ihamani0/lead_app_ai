...
export default function InstanceCard({ instance }: InstanceCardProps) {
    ...
    const statusStyles = {
        connected: {
            ...
            style: ` border-emerald-200/50 from-emerald-50/80 to-white dark:border-emerald-500/20 dark:from-emerald-950/30 dark:to-background`,
        },
        ...
        connecting: {
            ...
            bar: 'bg-amber-500',
            indicator:
                'bg-amber-500 animate-pulse shadow-sm shadow-amber-500/40',
            text: 'text-amber-600 dark:text-amber-400',

            style: `border-amber-200/50 from-amber-50/80 to-white dark:border-amber-500/20 dark:from-amber-950/30 dark:to-background`,
        },
        ...
        disconnected: {
            ...
            style: `border-destructive/30 from-destructive/5 to-white dark:border-destructive/20 dark:from-destructive/10 dark:to-background`,
        },
    };
